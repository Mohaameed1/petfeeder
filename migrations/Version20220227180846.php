 ...
 */
final class Version20220227180846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles JSON NOT NULL, DROP pets_id, DROP systemes_id, DROP admins_id, DROP nom, DROP prenom, DROP cin, DROP password');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE user ADD pets_id INT DEFAULT NULL, ADD systemes_id INT DEFAULT NULL, ADD admins_id INT DEFAULT NULL, ADD nom VARCHAR(255) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`, ADD prenom VARCHAR(255) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`, ADD cin INT DEFAULT NULL, ADD password VARCHAR(255) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`, DROP roles');
